...
resource "aws_api_gateway_integration_response" "response200IntegrationResponse" {
  depends_on = [aws_api_gateway_integration.S3Integration]
...
resource "aws_api_gateway_integration_response" "response400IntegrationResponse" {
  depends_on = [aws_api_gateway_integration.S3Integration]
...
resource "aws_api_gateway_integration_response" "response500IntegrationResponse" {
  depends_on = [aws_api_gateway_integration.S3Integration]
